    ...
    return (
        <View className="flex-row gap-2">
            <View className="flex-1">
                <View className="flex-1 flex-row bg-primary mb-2 rounded-xl">
                    ...
                    <View className="flex-1 justify-center pr-2">
                        <Text className="text-base text-[#ffffff80]">
                            Hướng gió
                        </Text>
                    </View>
                </View>
            ...
            <View className="flex-1 bg-primary p-2 rounded-xl">
                <View className="">
                    <CurrentItem label="Độ ẩm" value={`${data.humidity}%`} />
                    <CurrentItem
                        label="Cảm giác như"
                        value={`${data.feelslike_c}\u00B0`}
                    />
                    <CurrentItem label="UV" value={`${data.uv}`} />
                    <CurrentItem
                        label="Áp suất"
